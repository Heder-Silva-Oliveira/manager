...
const options = [{value:"Debito", label: "Debito"}, {value: "Credito", label: "Credito"}];
...
function profitSales (paran){
  ...
  return (
    ...
    <FormContainer ref={ref} onSubmit={handleSubmit}> 
      ...
      <InputArea>
        <Label>Produto</Label>
        <Select onChange={getIdProduct} options={
          product.map((item) => (
      ...
      <InputArea>
        ...
        <Input min="1" value={quantState} onChange={(e) => setQuant(e.target.value)} name="quant" type='number'/>
      </InputArea>
      <InputArea>
        <Label>Valor da venda</Label>
        <Input readonly value={montSales(productState) * quantState}
        name="mont"/>
      </InputArea>
      <InputArea>
        <Label>Lucro</Label>
        <Input readonly value={( montSales(productState) * quantState) - profitSales(productState) * quantState} name="profit" />
      </InputArea>
      <InputArea>
